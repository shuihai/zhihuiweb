...
<div class="container_inner" style="margin-top:100px;">            
    <div class="product_title">    
        <ul class="pttabbtn ul_clear" id="protitletab">
                <li class="on">
                    <img src="/Uploads/<?php echo ($robot['img']); ?>" />
                    <a href="javascript:void(0);"><?php echo ($robot['title']); ?></a>
                </li>
                <li>
                    <img src="/Uploads/<?php echo ($vr['img']); ?>" />
                    <a href="javascript:void(0);"><?php echo ($vr['title']); ?></a>
                </li>
                <!--<li>-->
                    <!--<img src="/Uploads/<?php echo ($biometrics['img']); ?>" />-->
                    ...
                    <div class="container_inner product_parameter">
                        ...
                        <div class="product_parameter_img">
                            ...
                            <div id="parameter_img">
                                <ul>
                                    <?php if(is_array($roMidFocus)): $i = 0; $__LIST__ = $roMidFocus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a class="fancybox"  data-fancybox-group="gallery"><img src="/Uploads/<?php echo ($vo['img']); ?>" rel="lightbox" /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
                            <script src="/Public/home/js/jquery.kxbdMarquee.js"></script>
                    ...
                    <div class="container_inner" style="height:399px;">
                       <div class="callbacks_container">
                            <ul id="scene_slider" class="scene_slider">
                                <?php if(is_array($roBottomFocus)): $i = 0; $__LIST__ = $roBottomFocus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="javascript:void(0)"><img src="/Uploads/<?php echo ($vo['img']); ?>" alt="<?php echo ($vo['title']); ?>" /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                            </ul>
                        </div>
                    </div>
                    <!--参数及焦点图部分结束-->
                ...
                <div class="pt_sublist">            
                    ...
                    <div class="clearfix"></div>
                        ...
                        <div class="container_inner" style="height:399px;">
                           <div class="callbacks_container">
                                <ul id="scene_slider" class="scene_slider">
                                    <?php if(is_array($VRBottomFocus)): $i = 0; $__LIST__ = $VRBottomFocus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="javascript:void(0)"><img src="/Uploads/<?php echo ($vo['img']); ?>" alt="<?php echo ($vo['title']); ?>" /></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
                        </div>
                    </div>    
                           ...
                           <!--<div class="callbacks_container">-->
                                <!--<ul id="scene_slider" class="scene_slider">-->
                                    <!--<?php if(is_array($biBottomFocus)): $i = 0; $__LIST__ = $biBottomFocus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
                                        <!--<li><a href="javascript:void(0)" style="width:1200px;height:399px;"><img src="/Uploads/<?php echo ($vo['img']); ?>" alt="<?php echo ($vo['title']); ?>" style="width:1200px;height:399px;"/></a></li>-->
